...
public class DataBaseHandler extends SQLiteOpenHelper {
        ...
        PojoClass getContact(int id) {
                ...
                PojoClass contact = new PojoClass(Integer.parseInt(cursor.getString(0)),
        ...
        public List<PojoClass> getAllContacts() {
                List<PojoClass> contactList = new ArrayList<PojoClass>();
                // Select All Query
        ...
        public int updateContact(PojoClass contact) {
                SQLiteDatabase db = this.getWritableDatabase();
